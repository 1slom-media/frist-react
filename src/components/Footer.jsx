            ...
            <ul className="footer__list">
                ...
                <li className="footer__item">
                    ...
                    <div className="socials__box">
                        <button className="footer__socials1 socials"></button>
                        <button className="footer__socials2 socials"></button>
                        <button className="footer__socials3 socials"></button>
                        <button className="footer__socials4 socials"></button>  
                    </div> 
                </li>
            </ul>
